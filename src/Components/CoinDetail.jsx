...
const CoinDetail = ({ id }) => {
  ...
  if (!coinData) return <div className="loading-text">Loading Terminal Data...</div>;
  ...
  return (
    <div className="coin-detail-card">
      ...
      <div className="detail-body">
        ...
        <p dangerouslySetInnerHTML={{ __html: coinData.description?.en || "No description available." }}></p>
      </div>
    </div>
  );
};
